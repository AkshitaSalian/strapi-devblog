...
export interface ApiBlogPageBlogPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    excludedTags: Schema.Attribute.Relation<'oneToMany', 'api::tag.tag'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'out blogs'>;
    pageInfo: Schema.Attribute.Component<'layout.page-info', false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCoursePageCoursePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    excludedCourses: Schema.Attribute.Relation<
      'oneToMany',
      'api::course.course'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'our courses'>;
    pageinfo: Schema.Attribute.Component<'layout.page-info', false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    showProfile: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    socialLinks: Schema.Attribute.Component<'config.social-link', true>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    dynamicHomeSection: Schema.Attribute.DynamicZone<
      ['layout.news-letter', 'layout.mission']
    >;
    ...
    > &
      Schema.Attribute.Private;
    postselection: Schema.Attribute.Component<'blog.post-selection', false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::menu.menu'> &
      Schema.Attribute.Private;
    mainMenu: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    menuItems: Schema.Attribute.Component<'layout.link', true>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'mainMenu'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSeoConfigSeoConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultseo: Schema.Attribute.Component<'seo.seoinformation', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface PluginGitHubProjectsProject
  extends Struct.CollectionTypeSchema {
  collectionName: 'git-hub-projects_project';
  info: {
    description: '';
    displayName: 'project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::git-hub-projects.project'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    repositoryId: Schema.Attribute.UID & Schema.Attribute.Unique;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    likes: Schema.Attribute.Relation<'manyToMany', 'api::post.post'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'plugin::git-hub-projects.project': PluginGitHubProjectsProject;
